...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: "/", siteName: "AARYVO", title: "AARYVO — Your AI Sales Employee", description: "Turn website conversations into qualified leads and booked appointments — automatically, 24/7." },
  twitter: { card: "summary_large_image", title: "AARYVO — Your AI Sales Employee", description: "Turn website conversations into qualified leads and booked appointments — automatically, 24/7." },
