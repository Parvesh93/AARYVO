...
export async function POST(request:Request){
 ...
 if(member.business.billingChannel==="SHOPIFY"||member.business.shopifyStore)return NextResponse.json({error:"This is a Shopify-billed workspace. Manage plan changes through Shopify."},{status:409});
